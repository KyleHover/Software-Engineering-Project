 ...
 * @author khover
 */
public class TestModA extends GameEngine{
    public TestModA(String mapPath, ICanvasDevice mainview, ICanvasDevice minimap, ICanvasDevice factoryPanel, ISoundDevice sound) {
