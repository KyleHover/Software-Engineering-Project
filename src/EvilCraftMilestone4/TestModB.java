 ...
 * @author khover
 */
public class TestModB extends GameEngine{
    public TestModB(String mapPath, ICanvasDevice mainview, ICanvasDevice minimap, ICanvasDevice factoryPanel, ISoundDevice sound) {
